...
from crm_easyoffice.users.views import UserRedirectView
from crm_easyoffice.users.views import UserUpdateView
from crm_easyoffice.users.views import user_detail_view
